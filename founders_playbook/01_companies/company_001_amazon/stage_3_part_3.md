...
`sources.csv` is global-append-only per company; 81 Stage-3 rows already exist, `S3001…S3081`).** [RETIRED-KEY REFERENCE — names the pre-re-key id space; not a citation]
...
## U. CONFLICTING EVIDENCE (STAGE 3) — U.114 → U.170

**U.169 — The Senior Discount Notes have TWO filed net-proceeds printings, $2.5m apart, and no document reconciles them.**
**CLAIM A:** net proceeds were **approximately $315.7 million** "after deducting selling commissions and transaction
expenses" (`424B2` acc. 0000891020-98-001279 **l.1355-1356**, filed 1998-08-13). **CLAIM B:** net proceeds were
**approximately $318.2 million from the Senior Discount Notes offering** (`10-K/98` **l.1635-1636**, filed
1999-03-05, re-printed at `10-K/99` l.2289 and `10-Q Q2-1998` l.1108).
**WHY THEY DIFFER:** two different expense sets applied to the same ~$326m gross. The 10-K figure sits beside the
financing-activity lines of the same statement — "Proceeds from long-term debt **325,987**" and "Financing costs
**(7,783)**" (`10-K/98` l.2260-2262) — whose difference is **318,204**, so the audited net looks like gross cash
less *financing costs*, while the prospectus's looks like gross less *underwriting commissions plus transaction
expenses*. **This arithmetic is offered as a candidate reconciliation only, DERIVED from filed lines; it is not a
filed figure and it does not close the conflict.**
**EVIDENCE WEIGHT:** both Tier 1, both the issuer's own, and the 10-K/10-K/A/10-Q re-prints are **one lineage**
(method §3), so this is **two printings, not two corroborations**. Neither outranks the other.
**BEST-SUPPORTED INTERPRETATION:** print **both**, each with its carrier and its denominator label, and never let
the gross figure stand alone as "capital raised": **gross $326m · net $315.7m / $318.2m · principal at maturity
$530m** are four quantities of one instrument. Opened on the adversarial-repair pass because the audit's own
instruction ("carry net proceeds $318.2m") would have replaced one filed figure with another.
**RESIDUAL UNCERTAINTY:** which expense set each net figure deducts is **UNKNOWN**; no expense schedule is filed
anywhere in `sources/`.
**CONFIDENCE:** Medium (each figure is filed; the gap is unexplained).

**U.170 — Senior indebtedness prints $349 million at 1998-12-31 and $291 million at 1999-03-31: a $58m fall with no disclosed discharge.**
**CLAIM A:** "As of December 31, 1998, we had approximately **$349 million** of outstanding senior indebtedness"
(`S-3` File No. 333-74435 **l.915** and **l.1325**, filed 1999-03-16 — **Risk Factors**, and the only two places the
digits occur in the corpus). **CLAIM B:** the same sentence-family prints "approximately **$291 million** of
outstanding senior indebtedness" at 1999-03-31 (`10-Q Q1-1999` **l.1607**, filed 1999-05-17).
**WHY THEY DIFFER:** three candidates and none is evidenced — (i) a **definitional** difference between "senior
indebtedness" as computed for the indenture's covenant tests and any balance-sheet caption; (ii) **accretion or
amortisation** of the discount notes' carrying value plus the 1999 quarter's new debt; (iii) an actual repayment,
refinancing, exchange or defeasance. **No such event is disclosed anywhere in the corpus between 1998-12-31 and
1999-03-31**: the FY1998 financing lines show senior-debt proceeds only (325,987) and a repayment line (78,108)
belonging to the Senior Loan year.
**EVIDENCE WEIGHT:** one carrier each, both risk-factor self-statements by the same registrant, both **not** audited
captions. The audited FY1998 long-term-debt caption (348,140) overlaps the 1998 leg and is already **U.131**; it
does not cover 1999-03-31, so nothing on disk adjudicates the movement.
**BEST-SUPPORTED INTERPRETATION:** record the pair as an **unresolved movement**; use neither figure as a trend point
and do not average them. The $349m stays as the stage's 1998-12-31 debt-overhang datum **with its carrier corrected
to S-3 333-74435 and its grade capped at single-source** (AD-01), and the $291m is registered but **not adopted**
into any §A or §K row.
**RESIDUAL UNCERTAINTY:** the cause of the $58m fall is **UNKNOWN**; whether any document outside `sources/` (a
1999 10-Q exhibit or the indenture's own certificate-of-compliance regime) would explain it is untried.
**CONFIDENCE:** Low (the movement is filed twice; its cause is nowhere).
